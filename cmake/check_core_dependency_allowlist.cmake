...
foreach(_index RANGE ${_last_dependency_index})
  ...
  list(FIND _expected_ports "${_port}" _expected_index)
  list(FIND _seen_ports "${_port}" _seen_index)
  if(_expected_index EQUAL -1 OR NOT _seen_index EQUAL -1)
    message(FATAL_ERROR
      "CoreDependencyAllowlist unexpected or duplicate direct dependency: ${_port}")
  endif()
  list(GET _expected_versions ${_expected_index} _expected_version)
  if(NOT _version STREQUAL _expected_version)
    message(FATAL_ERROR
      "CoreDependencyAllowlist unexpected direct dependency version: ${_port} ${_version}")
  endif()
  list(APPEND _seen_ports "${_port}")
endforeach()
