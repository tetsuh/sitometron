...
| ADR | Status | Decision |
|---|---|---|
| [0001](0001-bootstrap-a-stdlib-only-cpp20-core.md) | Accepted | Bootstrap a standard-library-only C++20 core |
| [0002](0002-define-core-job-reducer-contract.md) | Accepted | Define the core Job reducer contract |
| [0004](0004-allow-explicit-core-dependencies.md) | Proposed | Allow explicit dependencies in the C++20 core |
