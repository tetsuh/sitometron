...
| `JRN-004` | C++ tests `journal_record_roundtrip_vectors`, `journal_record_size_bound`, `journal_parser_rejects_noncanonical` | Planned under Proposed ADR-0006 under Issue #51; normative on acceptance |
