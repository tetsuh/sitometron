...
|---|---|---|---|---|
| Core/adapter standard-library-only dependency boundary | Normative | Implemented | [ADR-0001](adr/0001-bootstrap-a-stdlib-only-cpp20-core.md); remains effective while ADR-0004 is Proposed | Phase 0A |
| Approved core dependency boundary and allowlist | Planned | Planned | Proposed [ADR-0004](adr/0004-allow-explicit-core-dependencies.md) under [Issue #15](https://github.com/tetsuh/sitometron/issues/15) | Phase 0A |
