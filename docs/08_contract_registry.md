...
| JobJournal envelope and event schemas | Normative | Implemented | Accepted [ADR-0002](adr/0002-define-core-job-reducer-contract.md) for the logical contract; Issue #11 implements the owned C++ envelope and logical fake; Issue #12 implements complete logical envelope construction, non-wrapping sequence allocation, and commit ordering; Phase 0B ADR remains pending for physical serialization and durability | Phase 0A / 0B |
