...
| JobJournal envelope and event schemas | Normative | In progress | Accepted [ADR-0002](adr/0002-define-core-job-reducer-contract.md) for the logical contract; Issue #11 implements the owned C++ envelope and logical fake; Issue #12 owns writer construction, sequence allocation, and logical ordering; Phase 0B ADR pending for physical durability | Phase 0A / 0B |
